...
8. AI context is bounded to the target workspace/ticket and up to five published knowledge articles from the same workspace.
9. External message sending, shell execution, infrastructure changes, account/role changes, ticket closure and other mutations remain exclusively deterministic application actions behind their existing permissions.
