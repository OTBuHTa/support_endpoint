...
- **Phase 6A — Knowledge + Advisory AI** ✅ knowledge articles, AI permissions, redaction, bounded context, immutable suggestions, local OpenAI-compatible gateway and workspace rate limit (ADR-007).
