...
[[ -r tools/restore-verify.sh ]] || fail "tools/restore-verify.sh is missing or unreadable"
[[ -r tools/smoke-production.sh ]] || fail "tools/smoke-production.sh is missing or unreadable"
